...
public class SoapUIPlugin implements ProjectComponent {
    ...
    private SoapUIPlugin.InternalDesktopListenerAdapter internalDesktopListenerAdapter;
...
// dont show the popup..
    ...
    public void initToolWindow() {
        ...
        ContentFactory pf = ContentFactory.SERVICE.getInstance();
        Content content = pf.createContent(buildMainPanel(), "", false); // first arg is a JPanel
